...
- [Конфигурация MkDocs Material](coursework/mkdocs.yml)
- [Готовая статическая сборка](coursework/site/)

Семь страниц, поиск на русском языке, собственная цветовая схема, фото в рамке и галерея мемов.
